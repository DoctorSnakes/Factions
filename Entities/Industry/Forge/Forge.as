...
void onInit(CBlob@ this)
{
	...
	AddIconToken( "$titanarmor_$", "TITAN.png", Vec2f(32,32), 0);
	...
	this.set_Vec2f("shop menu size", Vec2f(8, 7));
	...
	{
		ShopItem@ s = addShopItem(this, "Titan Sword", "$titanblade_$", "titanblade", "A sword made of titan. x2.5 dmg", false);
	...
	{
		ShopItem@ s = addShopItem(this, "Platium Bow", "$platiumbow_$", "platiumbow", "A bow made of platium. x2 dmg", false);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 200);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 350);
	}
	{
		ShopItem@ s = addShopItem(this, "Titan Bow", "$titanbow_$", "titanbow", "A bow made of titan. x2.5 dmg", false);
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 350);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 750);
	}
	{
