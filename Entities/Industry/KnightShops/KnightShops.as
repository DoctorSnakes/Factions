...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Bomb Factory", "$bombfactory$", "bombfactory", "Creates bombs");
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 50);
	}
	{
		ShopItem@ s = addShopItem(this, "Water Bomb Factory", "$waterbombfactory$", "waterbombfactory", "Creates Water Bombs");
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 100);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 50);
	}
	{
		ShopItem@ s = addShopItem(this, "Mine Factory", "$minefactory$", "minefactory", "Creates Mines");
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 200);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 150);
	}
	{
		ShopItem@ s = addShopItem(this, "Keg Factory", "$kegfactory$", "kegfactory", "Creates Kegs");
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 200);
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 150);
