...
void onTick(CBlob@ this)
{
	...
	if(this.getName() == "knight")
	{
		...
		else if(this.get_string("sword") == "titanblade")
		{
			this.set_f32("dmgmult",2.5f);
			if(this.get("moveVars", @moveVars))
			{
    ...
    else if(this.get_string("sword") == "bloodatuns")
		{
			this.set_f32("dmgmult",1.25f);
      if(this.get("moveVars", @moveVars))
			{
	...
	if(this.getName() == "knight" || this.getName() == "builder")
	{
		...
		else if(this.get_string("armor") == "titanarmor")
		{
			if(this.get("moveVars", @moveVars))
			{
				moveVars.walkFactor *= 0.75f;
	...
	if(this.getName() == "archer")
	{
		...
		else if(this.get_string("bow") == "titanbow")
		{
			this.set_f32("dmgmult",2.5f);
			if(this.get("moveVars", @moveVars))
			{
